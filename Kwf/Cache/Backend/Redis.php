 ...
 * @copyright  Starfish
 * @copyright  daHaimi
 * @see        https://github.com/linqia/Zend_Cache_Backend_Redis
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Kwf_Cache_Backend_Redis extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface
{
    /**
     * Default Values
     */
    ...
    protected function _connect()
    {
        if (!$this->_connected) {
            try {
                ...
                if (! is_null($this->_options['socket'])) {
